...
const fioAddPublicAddress = async () => {
  ...
  chainId = 'b20901380af44ef59c5918439a1f9a41d83669020319a80574b804a5f95cbd7e'  // info.chain_id;
  ...
  transaction2 = {
    ...
    ref_block_prefix: 1292004762,
     actions: [{
         ...
         name: 'addaddress',
         authorization: [{
           actor: 'ifnxuprs2uxv',   //actor: user.account,
             permission: 'active',
         }],
         data: {
           fio_address: 'etest6@fiotestnet', // user.address,
            public_addresses: [
              {
                chain_code: 'BCH',
                token_code: 'BCH',
